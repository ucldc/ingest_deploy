...
function check_api_url()
{
    ...
    if [ $last_exit -ne 0 ]; then
        errecho
        errecho "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
        errecho "!!!!!!!!!! API ${env_name} DOWN!!!!!!"
        errecho "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
        errecho
        errecho "Check ${url_api} before swapping"
        errecho "wget --no-check-certificate --header \"X-Authentication-Token: <api_key>\"  ${url_api} before swapping"
    else
...
# Update the index running on the given environment with the new index S3 sub-path
    ...
    if [ "$env_cname" == "eb-ucldc-solr2.us-west-2.elasticbeanstalk.com" ]; then
        ...
        (errecho "!!!!!!!!!! URL ENV ${env_cname} !!!!!!")
        (errecho "!!!!!!!!!! BRINGING THIS DOWN WILL BREAK CALISPHERE !!!!!!")
        (errecho "!!!!!!!!!! EXITING !!!!!!")
        (errecho "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        (errecho)
	subject="Update Beanstalk index for ${env_name} failed"
